...
![JevGPT architecture: OpenAI token vocabulary and conversation feed four stratified samples, four parallel Jev drafts, then a Jev verifier that appends a token and repeats or finishes on DONE.](assets/architecture.svg)
